...
export default function Profile() {
  ...
  const profileUrl = selectedFile
    ...
    : profileData.profile;
  const backgroundUrl = selectedBackground
    ? URL.createObjectURL(selectedBackground as File)
        ...
        <div className="relative">
          <div className="h-56 overflow-hidden rounded-t-2xl relative">
            {backgroundUrl || profileData.background ? (
              ...
              <div className="w-full h-full place-content-center place-items-center object-cover bg-gray-300">
          ...
          <div className="flex items-end gap-5 absolute -bottom-20 left-6">
            <div className="relative group">
              <ProfileImage
                image={
                  profileUrl || profileData.profile || "/profile-picture.png"
                }
            ...
            <div className="text-left pb-2 pt-6 place-content-center">
              <h3 className="text-4xl font-bold text-shadow-sm shadow-[black]">
                ...
                <span className="text-sm text-sky-400">{`@${profileData.username}`}</span>
              </h3>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <InputGroup
                    label="Full Name"
                    text="Make sure this matches your government ID."
                  >
              ...
              <div className="mt-6">
                <InputGroup
                  ...
                  text="Keep your contact details up to date."
                >
              ...
              <div className="mt-6">
                <InputGroup
                  label="Government ID"
                  text="Ensure this matches your official ID."
                >
                  <Input
                    label="Government ID Number"
                    errorMessage={errors.govId?.message}
                    {...register("govId", {
              ...
              <div className="flex gap-4 mt-8">
                ...
                <Button variant="solid" onPress={() => setEditMode(false)}>
                  Cancel
                </Button>
              </div>
            </form>
              ...
              <div className="gap-8">
                ...
                <ul className="space-y-4">
                  <li className="flex border-b pb-4">
                    ...
                    <span className="text-gray-200 w-3/5">
